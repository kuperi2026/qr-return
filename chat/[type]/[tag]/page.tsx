...
export default function LiveChatPage() {
  ...
  async function sendMessage(
    ...
    if (!message || !sessionId || !validChat) {
      return;
    }
    ...
    <main className="page">
      ...
      <section className="chatPage">
        ...
        <div className="chatNotice">
          ...
          <p>
            {ka
              ? "ეს ჩატი განკუთვნილია ნივთის, ცხოველის ან Emergency QR პროფილთან დაკავშირებული კომუნიკაციისთვის."
              : "This chat is for communication related to the item, pet or Emergency QR profile."}
          </p>
        </div>
        ...
        <div className="privacyNote">
          🔒{" "}
          {ka
            ? "არ გააზიაროთ პაროლები, საბანკო მონაცემები ან სხვა ზედმეტი კონფიდენციალური ინფორმაცია."
            : "Do not share passwords, banking details or unnecessary sensitive information."}
        </div>
