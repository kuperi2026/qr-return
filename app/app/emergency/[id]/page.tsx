...
export default function EmergencyAppProfile() {
  ...
  `}</style><style jsx global>{`
    .emApp{overflow-x:hidden}.emWrap{overflow:hidden;padding-left:11px;padding-right:11px}.emPanels{margin-top:10px;gap:6px}.emPanel{width:100%;border-radius:12px;box-shadow:0 3px 10px rgba(23,63,109,.04)}.emPanel summary{width:100%;min-height:48px;padding:6px 8px;gap:8px;touch-action:manipulation}.emPanel summary i{width:30px;height:30px;flex-basis:30px;border-radius:9px;font-size:12px}.emPanel summary span{overflow:hidden}.emPanel summary b{font-size:10px;line-height:1.2}.emPanel summary small{display:none}.emPanel summary em{width:26px;height:26px;flex-basis:26px;border-radius:8px;font-size:14px;transition:none}.emPanel[open] summary em{transform:none}.panelBody{padding:10px}.emHero{padding:13px;border-radius:15px}.emPhoto{width:56px;height:56px;flex-basis:56px;border-radius:15px;font-size:28px}.emHero h1{font-size:18px}.panelBody .appAi{margin:0!important;border:0!important;border-radius:0!important;box-shadow:none!important}.panelBody .appAi form{padding:9px 10px 10px!important;background:#f7fbff!important}.panelBody .quickScenarios{margin-top:7px!important}.panelBody .quickScenarios>div{margin-top:5px!important;display:grid!important;grid-template-columns:1fr!important;gap:4px!important;overflow:visible!important}.panelBody .quickScenarios button{min-height:30px!important;padding:4px 8px!important;border-radius:8px!important;font-size:8px!important;white-space:normal!important}.panelBody .appAi form>label{margin-top:8px!important;font-size:9px!important}.panelBody .appAi textarea{min-height:62px!important;padding:8px!important;font-size:11px!important}.panelBody .consent{font-size:8px!important}.panelBody .analyze{height:38px!important;margin-top:8px!important;font-size:9px!important}
  `}</style></main>;
}
