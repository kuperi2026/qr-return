...
const steps = [
  ...
  { title: "შეჯამება და შეძენა", text: "შეამოწმეთ რეგისტრირებული პროფილები, თითოეულზე არჩეული ვადა, ფასდაკლება და ჯამი; შემდეგ გაგზავნეთ გააქტიურების მოთხოვნა." },
];
  ...
  return (
    <main className="guide-page">
      <div className="guide-wrap">
        ...
        <section className="guide-card">
          ...
          <div className="player" aria-live="polite">
            ...
            {active === steps.length - 1 && <div className="video-end-note"><b>დაიმახსოვრეთ</b><span>ირჩევთ რეგისტრირებულ პროფილებს, თითოეულზე ცალკე ვადას და აერთიანებთ ერთ შეძენაში.</span></div>}
          ...
          <aside className="final-note">
            <span>✓</span>
            <div><b>აირჩიეთ რამდენიმე რეგისტრირებული პროფილი</b><p>თითოეულ პროფილს ცალ-ცალკე მიუთითებთ სასურველ ვადას. სხვადასხვა ვადა ერთ შეკვეთაში გაერთიანდება და რაოდენობრივი ფასდაკლება ავტომატურად დაითვლება.</p></div>
          </aside>
      ...
      <style jsx global>{`
        ...
        .guide-page{background:#0a4c8a}.guide-card{padding:14px;border:1px solid rgba(255,255,255,.8);background:#f7fbff;box-shadow:0 22px 50px rgba(0,31,73,.32)}.play-icon{background:#0870d8;box-shadow:0 8px 18px rgba(8,112,216,.24)}.player{border:1px solid #d4e3f0;box-shadow:0 12px 26px rgba(9,50,96,.2)}.scene{background:#0b579c}.step-number{background:#fff;color:#0870d8}.video-end-note{padding:10px 15px;display:grid;gap:3px;background:#eaf9f2;color:#176448}.video-end-note b{font-size:10px}.video-end-note span{font-size:9px;line-height:1.45}.final-note{margin-top:12px;padding:12px;display:flex;align-items:flex-start;gap:10px;border:1px solid #ccebdd;border-radius:14px;background:#effbf6}.final-note>span{width:29px;height:29px;display:grid;place-items:center;flex:0 0 29px;border-radius:9px;background:#0aa36b;color:#fff;font-size:12px;font-weight:950}.final-note b{display:block;color:#126044;font-size:11px;line-height:1.4}.final-note p{margin:5px 0 0;color:#527566;font-size:9px;line-height:1.55}.open-packages{margin-top:12px;background:#0870d8;color:#fff;box-shadow:0 8px 18px rgba(8,112,216,.2)}
      `}</style>
    </main>
  );
}
