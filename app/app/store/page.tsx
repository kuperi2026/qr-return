...
const products = [
  ["🐕", "ძაღლის QR", "საყელოს სტიკერი ან ბრელოკი", "მალე"],
  ["🐈", "კატის QR", "მსუბუქი QR ნიშნული საყელოსთვის", "მალე"],
  ["✚", "Emergency QR", "პირველი და მესამე პირის დამცავი ნაკრები", "მალე"],
  ["👜", "ჩანთის QR", "მტკიცე სტიკერი ან ბრელოკი", "მალე"],
  ["🧳", "ჩემოდნის QR", "მოგზაურობის გამძლე ნიშნული", "მალე"],
  ["👛", "საფულის QR", "თხელი დამცავი QR ბარათი", "მალე"],
  ["🔑", "გასაღების QR", "კომპაქტური QR ბრელოკი", "მალე"],
  ["🚘", "მანქანის პარკინგის QR", "მძღოლთან უსაფრთხო დაკავშირებისთვის", "მალე"],
];

export default function AppStorePage() {
  return <main className="storePage"><div className="storeWrap">
    <Link href="/app/products" className="back">← ჰაბი</Link>
    <header><small>KOMPASI QR PRODUCTS</small><h1>QR პროდუქტები</h1><p>აირჩიეთ ის კატეგორია, რომლისთვისაც QR პროდუქტი გჭირდებათ. ფოტოები, ფასები და დაცული გადახდა დაემატება შემდეგ ეტაპზე.</p></header>
