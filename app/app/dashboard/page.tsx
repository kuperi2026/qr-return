    ...
    <main className="contactHome">
      <div className="homeWrap">
        ...
        <section className="premiumShortcuts" aria-label={ka ? "სწრაფი მოქმედებები" : "Quick actions"}>
          <Link href="/support?source=app" className="supportShortcut">
            <span>?</span><b>24/7</b><small>{ka ? "კონტაქტი" : "Contact"}</small>
          </Link>
          <Link href="/app/chat" className="chatShortcut">
            <span>◌</span><b>{ka ? "ჩათი" : "Chat"}</b><small>{ka ? "მპოვნელი" : "Finder"}</small>
          </Link>
          <button type="button" className="lostShortcut" onClick={() => setShowProducts((current) => !current)}>
            <span>!</span><b>Lost</b><small>Mode</small>
          </button>
        </section>
      ...
      <style jsx global>{`
        *{box-sizing:border-box}.contactHome{min-height:100vh;background:radial-gradient(circle at 92% 0%,rgba(13,181,139,.2),transparent 25%),radial-gradient(circle at 5% 5%,rgba(36,124,245,.35),transparent 32%),linear-gradient(180deg,#05182d 0%,#082e50 52%,#061f38 100%);color:#fff;font-family:"Noto Sans Georgian",Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}.homeWrap{width:min(520px,100%);margin:auto;padding:0 14px 108px}.homeHeader{min-height:82px;display:flex;align-items:center;justify-content:space-between;gap:10px}.userWelcome{min-width:0;display:flex;align-items:center;gap:10px}.userAvatar{width:42px;height:42px;display:grid;place-items:center;flex:0 0 42px;border:1px solid rgba(255,255,255,.3);border-radius:50%;background:linear-gradient(145deg,#2b8fe8,#0aa57a);color:#fff;font-size:16px;font-weight:950;box-shadow:0 8px 20px rgba(0,17,37,.28)}.userWelcome>span:last-child{min-width:0}.userWelcome small,.userWelcome b{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.userWelcome small{color:#aac7dd;font-size:8px;text-transform:capitalize}.userWelcome b{margin-top:3px;font-size:15px}.headerTools{display:flex;align-items:center;gap:7px}.languageSwitch{padding:3px;display:flex;border:1px solid rgba(255,255,255,.22);border-radius:11px;background:rgba(255,255,255,.08)}.languageSwitch button{height:29px;padding:0 7px;border:0;border-radius:8px;background:transparent;color:#9fbed5;font-family:inherit;font-size:8px;font-weight:950;cursor:pointer}.languageSwitch button.active{background:#fff;color:#075a9d;box-shadow:0 4px 10px rgba(0,18,38,.18)}.notificationButton{position:relative;width:41px;height:41px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.28);border-radius:13px;background:linear-gradient(145deg,rgba(255,255,255,.19),rgba(255,255,255,.08));color:#fff;text-decoration:none;backdrop-filter:blur(12px);box-shadow:0 8px 18px rgba(0,18,38,.2)}.notificationButton svg{width:20px;height:20px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}
        .premiumShortcuts{margin:0 0 11px;display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.premiumShortcuts>a,.premiumShortcuts>button{min-width:0;height:72px;padding:8px 7px;display:grid;grid-template-columns:36px 1fr;grid-template-rows:1fr 1fr;align-items:center;column-gap:8px;border:1px solid rgba(255,255,255,.2);border-radius:18px;color:#fff;text-align:left;text-decoration:none;font-family:inherit;cursor:pointer;box-shadow:0 12px 26px rgba(0,14,31,.25),inset 0 1px 0 rgba(255,255,255,.2);backdrop-filter:blur(14px)}.premiumShortcuts span{grid-row:1/3;width:36px;height:36px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.2);border-radius:12px;background:rgba(255,255,255,.15);font-size:17px;font-weight:950}.premiumShortcuts b{align-self:end;font-size:11px}.premiumShortcuts small{align-self:start;margin-top:2px;color:rgba(255,255,255,.72);font-size:7px;font-weight:800}.supportShortcut{background:linear-gradient(145deg,rgba(24,124,217,.88),rgba(7,83,151,.86))}.chatShortcut{background:linear-gradient(145deg,rgba(9,157,154,.88),rgba(4,94,115,.88))}.lostShortcut{background:linear-gradient(145deg,rgba(184,55,76,.9),rgba(112,31,57,.9))}
        .contactHero{position:relative;overflow:hidden;min-height:287px;padding:151px 20px 22px;text-align:center;border:1px solid rgba(133,205,255,.28);border-radius:25px;background:linear-gradient(145deg,rgba(13,79,139,.96),rgba(5,36,70,.98) 58%,rgba(5,103,81,.93));box-shadow:0 27px 60px rgba(0,12,29,.4),inset 0 1px 0 rgba(255,255,255,.18)}.contactHero:after{content:"";position:absolute;right:-70px;top:-92px;width:185px;height:185px;border:29px solid rgba(255,255,255,.055);border-radius:50%}.returnSignal{position:absolute;z-index:0;left:50%;top:10px;width:136px;height:136px;opacity:.95;transform:translateX(-50%)}.signalRing{position:absolute;left:50%;top:50%;border:1px solid rgba(158,230,214,.22);border-radius:50%;transform:translate(-50%,-50%)}.ringOne{width:122px;height:122px}.ringTwo{width:92px;height:92px;border-style:dashed}.returnPath{position:absolute;inset:8px;width:120px;height:120px}.returnPath path{stroke:rgba(181,241,226,.5);stroke-width:1.35;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:3 5}.signalNode{position:absolute;width:7px;height:7px;border:2px solid rgba(255,255,255,.75);border-radius:50%;background:#2adea5;box-shadow:0 0 0 4px rgba(42,222,165,.09)}.nodeOne{left:10px;bottom:34px}.nodeTwo{right:16px;top:25px;background:#5db2ff}.nodeThree{right:8px;bottom:29px;width:5px;height:5px;background:#ffd66c}.signalTag{position:absolute;left:50%;top:50%;width:54px;height:64px;display:grid;place-items:center;border:4px solid rgba(255,255,255,.86);border-radius:15px;background:linear-gradient(145deg,#1687e4,#0bab83);box-shadow:0 13px 25px rgba(0,20,42,.26);transform:translate(-50%,-50%) rotate(5deg)}.signalTag:after{content:"";position:absolute;right:-7px;top:23px;width:7px;height:14px;border-radius:0 7px 7px 0;background:rgba(255,255,255,.9)}.signalTag i{position:absolute;top:4px;width:6px;height:6px;border:1.5px solid #fff;border-radius:50%}.signalTag svg{width:31px;height:31px;margin-top:7px;fill:#fff;transform:rotate(-5deg)}.returnSignal>b{position:absolute;right:6px;bottom:2px;width:22px;height:22px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.38);border-radius:50%;background:rgba(5,35,65,.72);color:#a9f2dc;font-size:9px;box-shadow:0 5px 12px rgba(0,12,27,.22)}.online{position:relative;z-index:1;display:inline-flex;align-items:center;gap:7px;color:#a8f0d7;font-size:8px;font-weight:950;letter-spacing:1.1px}.online i{width:7px;height:7px;border-radius:50%;background:#25d99d;box-shadow:0 0 0 5px rgba(37,217,157,.13)}.contactHero h1{position:relative;z-index:1;margin:12px auto 0;font-size:27px;letter-spacing:-.5px}.contactHero>p{position:relative;z-index:1;max-width:340px;margin:7px auto 0;color:#d2e7f5;font-size:11px;line-height:1.55}
        ...
        @media(max-width:400px){.premiumShortcuts{gap:5px}.premiumShortcuts>a,.premiumShortcuts>button{height:66px;padding:7px 5px;grid-template-columns:31px 1fr;column-gap:5px}.premiumShortcuts span{width:31px;height:31px}.contactHero{min-height:273px;padding-top:142px}.returnSignal{top:7px;transform:translateX(-50%) scale(.9)}.contactHero h1{font-size:24px}}
      `}</style>
    </main>
  );
}
