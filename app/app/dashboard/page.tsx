...
export default function Dashboard() {
  ...
  return <main className="simpleDash"><div className="dashWrap">
    ...
    <section className="compactActions"><Link className="profilesAction" href="/app/profiles"><i>▤</i><span><b>პროფილების მართვა</b></span><em>›</em></Link><Link href="/app/chat"><i>◌</i><span><b>Live Chat</b><small>მპოვნელის შეტყობინებები</small></span><em>›</em></Link><Link href="/app/account"><i>◇</i><span><b>მომსახურება და პაკეტები</b><small>ანგარიში და პირობები</small></span><em>›</em></Link></section>
