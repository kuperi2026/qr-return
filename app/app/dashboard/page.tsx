...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      setFirstName([user.user_metadata?.first_name, user.user_metadata?.last_name].filter(Boolean).join(" "));
    ...
    <main className="contactHome">
      <div className="homeWrap">
        ...
        <section className="contactHero">
          <span className="productBubble dog">🐕</span>
          <span className="productBubble cat">🐈</span>
          <span className="productBubble keys">🔑</span>
          <span className="productBubble wallet">👛</span>
          <span className="productBubble bag">👜</span>
          <span className="productBubble suitcase">🧳</span>
          <span className="productBubble parking">🚘</span>
          <span className="productBubble emergency">✚</span>
      ...
      <style jsx global>{`
        *{box-sizing:border-box}.contactHome{min-height:100vh;background:radial-gradient(circle at 92% 0%,rgba(13,181,139,.2),transparent 25%),radial-gradient(circle at 5% 5%,rgba(36,124,245,.35),transparent 32%),linear-gradient(180deg,#05182d 0%,#082e50 52%,#061f38 100%);color:#fff;font-family:"Noto Sans Georgian",Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif}.homeWrap{width:min(520px,100%);margin:0 auto;padding:26px 16px 108px;display:flex;flex-direction:column;gap:18px}.homeHeader{width:100%;margin-bottom:2px;display:flex;align-items:center;justify-content:space-between;gap:14px}.userWelcome{min-width:0;display:flex;align-items:center;gap:11px}.userAvatar{width:46px;height:46px;display:grid;place-items:center;flex:0 0 46px;border:1px solid rgba(255,255,255,.3);border-radius:50%;background:linear-gradient(145deg,#2b8fe8,#0aa57a);color:#fff;font-size:18px;font-weight:950;box-shadow:0 8px 20px rgba(0,17,37,.28)}.userWelcome>span:last-child{min-width:0}.userWelcome small,.userWelcome b{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.userWelcome small{color:#c0d9ea;font-size:10px;font-weight:750;text-transform:capitalize}.userWelcome b{margin-top:4px;font-size:19px;line-height:1.1}.headerTools{display:flex;align-items:center;gap:7px}.languageSwitch{padding:3px;display:flex;border:1px solid rgba(255,255,255,.22);border-radius:11px;background:rgba(255,255,255,.08)}.languageSwitch button{height:31px;padding:0 8px;border:0;border-radius:8px;background:transparent;color:#b1ccdf;font-family:inherit;font-size:9px;font-weight:950;cursor:pointer}.languageSwitch button.active{background:#fff;color:#075a9d;box-shadow:0 4px 10px rgba(0,18,38,.18)}.notificationButton{position:relative;width:43px;height:43px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.28);border-radius:13px;background:linear-gradient(145deg,rgba(255,255,255,.19),rgba(255,255,255,.08));color:#fff;text-decoration:none;backdrop-filter:blur(12px);box-shadow:0 8px 18px rgba(0,18,38,.2)}.notificationButton svg{width:21px;height:21px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.notificationButton>b{position:absolute;right:-5px;top:-6px;min-width:19px;height:19px;padding:0 4px;display:grid;place-items:center;border:2px solid #082b4b;border-radius:10px;background:#ff5c68;color:#fff;font-size:9px;line-height:1;box-shadow:0 4px 9px rgba(0,0,0,.25)}
        .premiumShortcuts{width:100%;margin:0;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.premiumShortcuts>a,.premiumShortcuts>button{min-width:0;height:68px;padding:6px 4px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;overflow:hidden;border:1px solid rgba(255,255,255,.22);border-radius:15px;color:#fff;text-align:center;text-decoration:none;font-family:inherit;cursor:pointer;box-shadow:0 9px 20px rgba(0,14,31,.23),inset 0 1px 0 rgba(255,255,255,.24);backdrop-filter:blur(14px)}.premiumShortcuts span{width:26px;height:26px;display:grid;place-items:center;flex:0 0 26px;border:1px solid rgba(255,255,255,.24);border-radius:8px;background:rgba(255,255,255,.17);font-size:14px;font-weight:950}.premiumShortcuts b{max-width:100%;overflow:hidden;font-size:10px;line-height:1.1;text-overflow:ellipsis;white-space:nowrap}.premiumShortcuts small{max-width:100%;overflow:hidden;color:rgba(255,255,255,.8);font-size:7px;font-weight:800;line-height:1.1;text-overflow:ellipsis;white-space:nowrap}.supportShortcut{background:linear-gradient(145deg,#1b83e2,#075699)}.chatShortcut{background:linear-gradient(145deg,#0aa49e,#056979)}.lostShortcut{background:linear-gradient(145deg,#c44159,#76213d)}
        .contactHero{position:relative;width:100%;overflow:hidden;min-height:292px;margin:0;padding:248px 20px 20px;text-align:center;border:1px solid rgba(133,205,255,.28);border-radius:28px;background:linear-gradient(145deg,rgba(13,79,139,.96),rgba(5,36,70,.98) 58%,rgba(5,103,81,.93));box-shadow:0 27px 60px rgba(0,12,29,.4),inset 0 1px 0 rgba(255,255,255,.18)}.contactHero:after{content:"";position:absolute;right:-70px;top:-92px;width:185px;height:185px;border:29px solid rgba(255,255,255,.055);border-radius:50%}.returnSignal{position:absolute;z-index:2;left:50%;top:61px;width:150px;height:150px;opacity:.98;transform:translateX(-50%) scale(1.05)}.signalRing{position:absolute;left:50%;top:50%;border:1px solid rgba(158,230,214,.22);border-radius:50%;transform:translate(-50%,-50%)}.ringOne{width:134px;height:134px}.ringTwo{width:98px;height:98px;border-style:dashed}.returnPath{position:absolute;inset:15px;width:120px;height:120px}.returnPath path{stroke:rgba(181,241,226,.5);stroke-width:1.35;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:3 5}.signalNode{position:absolute;width:7px;height:7px;border:2px solid rgba(255,255,255,.75);border-radius:50%;background:#2adea5;box-shadow:0 0 0 4px rgba(42,222,165,.09)}.nodeOne{left:10px;bottom:34px}.nodeTwo{right:16px;top:25px;background:#5db2ff}.nodeThree{right:8px;bottom:29px;width:5px;height:5px;background:#ffd66c}.signalTag{position:absolute;left:50%;top:50%;width:58px;height:69px;display:grid;place-items:center;border:4px solid rgba(255,255,255,.86);border-radius:16px;background:linear-gradient(145deg,#1687e4,#0bab83);box-shadow:0 13px 25px rgba(0,20,42,.26);transform:translate(-50%,-50%) rotate(5deg)}.signalTag:after{content:"";position:absolute;right:-7px;top:23px;width:7px;height:14px;border-radius:0 7px 7px 0;background:rgba(255,255,255,.9)}.signalTag i{position:absolute;top:4px;width:6px;height:6px;border:1.5px solid #fff;border-radius:50%}.signalTag svg{width:33px;height:33px;margin-top:7px;fill:#fff;transform:rotate(-5deg)}.returnSignal>b{position:absolute;right:6px;bottom:2px;width:22px;height:22px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.38);border-radius:50%;background:rgba(5,35,65,.72);color:#a9f2dc;font-size:9px;box-shadow:0 5px 12px rgba(0,12,27,.22)}.online{position:relative;z-index:3;display:inline-flex;align-items:center;gap:8px;color:#b8f4e1;font-size:10px;font-weight:950;letter-spacing:1.25px}.online i{width:8px;height:8px;border-radius:50%;background:#25d99d;box-shadow:0 0 0 5px rgba(37,217,157,.13)}.productBubble{position:absolute;z-index:1;width:34px;height:34px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.28);border-radius:11px;background:linear-gradient(145deg,rgba(255,255,255,.24),rgba(255,255,255,.08));font-size:16px;box-shadow:0 8px 18px rgba(0,15,34,.22);backdrop-filter:blur(8px)}.productBubble.dog{left:24px;top:30px}.productBubble.cat{right:25px;top:34px}.productBubble.keys{left:46px;top:92px}.productBubble.wallet{right:47px;top:96px}.productBubble.bag{left:27px;top:158px}.productBubble.suitcase{right:28px;top:163px}.productBubble.parking{left:70px;top:205px}.productBubble.emergency{right:71px;top:208px;color:#fff;font-weight:950}
        ...
        @media(max-width:400px){.homeWrap{padding-top:22px;gap:15px}.userWelcome small{font-size:9px}.userWelcome b{font-size:17px}.premiumShortcuts{gap:7px}.premiumShortcuts>a,.premiumShortcuts>button{height:64px}.premiumShortcuts b{font-size:9px}.contactHero{min-height:282px;padding-top:239px}.returnSignal{top:58px;transform:translateX(-50%) scale(1)}.productBubble{width:31px;height:31px;font-size:14px}.productBubble.dog{left:18px}.productBubble.cat{right:18px}.productBubble.keys{left:35px}.productBubble.wallet{right:35px}.productBubble.bag{left:20px}.productBubble.suitcase{right:20px}.productBubble.parking{left:55px}.productBubble.emergency{right:55px}}
      `}</style>
    </main>
  );
}
