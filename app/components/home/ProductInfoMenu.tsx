...
const itemsKa = [
  ["◆", "რა არის KOMPASI?", "KOMPASI არის QR-ზე დაფუძნებული სისტემა ნივთების, ცხოველების, ავტომობილებისა და Emergency პროფილებისთვის. მპოვნელს შეუძლია უსაფრთხოდ დაუკავშირდეს მფლობელს."],
  ...
  ["∞", "შეიძლება რამდენიმე QR პროფილის მართვა?", "დიახ. ერთი ანგარიშიდან შეგიძლიათ მართოთ ყველა თქვენი KOMPASI პროდუქტი და ნებისმიერ დროს განაახლოთ ინფორმაცია."],
...
const itemsEn = [
  ["◆", "What is KOMPASI?", "KOMPASI is a QR-based system for belongings, pets, vehicles and Emergency profiles. A finder can contact the owner safely."],
  ...
  ["∞", "Can I manage multiple QR profiles?", "Yes. Manage every KOMPASI product from one account and update information at any time."],
  ...
  ["✆", "How can a finder contact me?", "Depending on profile settings, a finder can call you or use KOMPASI's protected chat."],
      ...
      <div className="menuInner">
        <div className="menuTop">
          <div className="menuHeading">
            ...
            <p>{ka ? "ყველაფერი, რაც KOMPASI-ის გამოყენებამდე უნდა იცოდეთ." : "Everything you need to know before using KOMPASI."}</p>
          </div>
          <div className="links">
