...
export default function HomeLowerSection({ ka }: { ka: boolean }) {
  return (
    <section className="lower">
      <div id="how-it-works" className="sectionHead">
      ...
      <style jsx global>{`
        ...
        .lower{padding-top:42px;padding-bottom:48px}.accountStatement{padding:22px 34px;border-radius:18px}.accountStatement p{margin-top:8px;font-size:clamp(15px,1.7vw,19px);line-height:1.45}.sectionHead{margin-top:44px}.sectionHead h2{margin-top:7px;font-size:clamp(24px,2.8vw,34px)}.steps{margin-top:22px;gap:12px}.steps article{min-height:150px;padding:20px;border-radius:16px}.steps article>span{width:34px;height:34px;border-radius:10px;font-size:10px}.steps h3{margin-top:15px;font-size:16px}.steps p,.benefitIntro p,.support p{font-size:12px;line-height:1.5}.benefitArea{margin-top:40px;padding:27px 30px;border-radius:20px}.benefitIntro h2{margin-top:7px;font-size:clamp(23px,2.5vw,31px)}.support{margin-top:40px;padding:25px 30px;border-radius:18px}.support h2{margin-top:6px;font-size:24px}.supportActions a{min-width:170px;min-height:48px;padding:0 15px;font-size:12px}
        @media(max-width:800px){.lower{padding:34px 16px 40px}.accountStatement{padding:20px 17px}.steps{grid-template-columns:1fr}.steps article{min-height:0}.benefitArea{padding:22px 17px}.support{padding:22px 18px;display:block}.supportActions{margin-top:18px}.supportActions a{min-width:0;flex:1}.sectionHead,.benefitArea,.support{margin-top:34px}}
        @media(max-width:520px){.supportActions{display:grid}.supportActions a{width:100%}}
        .lower{padding:22px 32px 28px}.sectionHead{margin-top:0}.steps{margin-top:16px}.steps article{min-height:118px;padding:16px}.steps h3{margin-top:10px}.benefitArea{margin-top:22px;padding:20px}.support{margin-top:22px;padding:18px 24px}.support h2{font-size:21px}.supportActions a{min-height:42px}
        @media(max-width:800px){.lower{padding:20px 16px 26px}.sectionHead{margin-top:0}.steps article{min-height:0}.benefitArea,.support{margin-top:20px}}
      `}</style>
    </section>
  );
}
