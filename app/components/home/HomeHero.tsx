  ...
  return (
    <section className="homeHero">
      <div className="homeHeroInner">
        <div className="heroStage">
          <article className="ecosystemCircle">
            ...
            <h1>{ka ? "შექმენი შენი ციფრული QR პროფილი 20 წამში." : "Create your digital QR profile in 20 seconds."}</h1>
            <p>{ka ? "მართე ყველა პროდუქტი ერთი ანგარიშიდან, განაახლე ინფორმაცია ნებისმიერ დროს და თავად გადაწყვიტე, QR კოდის დასკანერებისას რა სახის დამატებითი ინფორმაცია მიაწოდო მპოვნელს." : "Manage every product from one account, update information at any time, and decide what additional information a finder sees after scanning the QR code."}</p>
          </article>
      ...
      <style jsx>{`
        ...
        .eyebrow{color:#d3ebff;font-size:10px;font-weight:900;letter-spacing:1.6px}h1{max-width:390px;margin:18px auto 0;color:#fff;font-size:clamp(28px,2.85vw,40px);line-height:1.14;letter-spacing:-1.3px}p{max-width:385px;margin:18px auto 0;color:rgba(255,255,255,.83);font-size:13px;line-height:1.65}
        .stageAccent{width:64%;min-height:460px;margin-left:-25px;padding:42px 45px 42px 95px;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;border:1px solid rgba(255,255,255,.2);border-left:0;border-radius:0 34px 34px 0;background:rgba(2,44,87,.28);text-align:left}.stageAccent>span{color:#acd7fb;font-size:9px;font-weight:900;letter-spacing:2px}.stageAccent h2{max-width:650px;margin:12px 0 0;color:#fff;font-size:clamp(25px,2.7vw,37px);line-height:1.15;letter-spacing:-1.1px}.detailCopy{max-width:670px;margin-top:20px;display:grid;gap:10px}.detailCopy p{max-width:none;margin:0;color:rgba(255,255,255,.78);font-size:11px;line-height:1.48}.detailCopy strong{color:#fff}
        ...
        @media(max-width:900px){.heroStage{min-height:auto;flex-direction:column;justify-content:center;gap:22px}.ecosystemCircle{width:min(500px,76vw);padding:clamp(42px,8vw,58px)}.stageAccent{width:100%;min-height:auto;margin:0;padding:30px;border-left:1px solid rgba(255,255,255,.2);border-radius:24px}.productRail{display:flex;overflow-x:auto;padding:3px 2px 17px;scroll-snap-type:x proximity}.productItem{min-width:170px;scroll-snap-align:start}.productImage{height:150px}}
