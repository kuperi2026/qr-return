...
export default function HomeHero({ ka }: { ka: boolean }) {
  ...
  return (
    <>
      ...
      <style jsx>{`
        .homeHero{color:#17324d;background:linear-gradient(180deg,#fff 0%,#f4f7fb 100%)}.homeHeroInner{width:calc(100% - 80px);max-width:1280px;margin:auto;padding:74px 0 86px}.heroTitle{max-width:1040px;margin:0 auto;text-align:center}.heroTitle>span{color:#1266e9;font-size:11px;font-weight:900;letter-spacing:1.5px}.heroTitle h1{margin:14px 0 0;color:#15324f;font-size:clamp(29px,2.8vw,40px);line-height:1.22;letter-spacing:-1px}.heroTitle p{max-width:820px;margin:18px auto 0;color:#66798d;font-size:18px;line-height:1.65}.productExperience{margin-top:48px;display:grid;grid-template-columns:285px minmax(430px,1fr) 285px;gap:24px;align-items:center}.orbitFrame{min-width:0;display:flex;justify-content:center}
...
function InfoPanel({ eyebrow, title, items }: { eyebrow: string; title: string; items: Benefit[] }) {
  ...
  return (
    <aside className="infoPanel">
      ...
      <style jsx>{`
        .infoPanel{padding:23px 20px;border:1px solid #dbe4ee;border-radius:20px;background:#fff;box-shadow:0 18px 42px rgba(30,64,105,.09)}.infoPanel>span{color:#1266e9;font-size:9px;font-weight:900;letter-spacing:1.3px}.infoPanel h2{margin:10px 0 0;color:#17324d;font-size:21px;line-height:1.3}.accordion{margin-top:17px}.benefit{border-top:1px solid #e4eaf1}.benefit button{width:100%;min-height:49px;padding:10px 0;display:grid;grid-template-columns:23px 1fr 20px;align-items:center;gap:8px;border:0;background:transparent;color:#17324d;text-align:left;cursor:pointer}.benefit button b{color:#8b9bad;font-size:8px}.benefit button strong{font-size:13px;font-weight:850;line-height:1.35}.benefit button i{width:20px;height:20px;display:grid;place-items:center;border:1px solid #cad7e6;border-radius:50%;font-style:normal;font-size:14px}.benefit p{margin:-1px 0 13px;padding:0 0 0 31px;color:#63778d;font-size:12px;line-height:1.58}.benefit.open button i{border-color:#1266e9;background:#1266e9;color:#fff}.benefit.open button strong{color:#1266e9}@media(max-width:760px){.infoPanel{padding:20px}.infoPanel h2{font-size:20px}.benefit button strong{font-size:14px}.benefit p{font-size:13px}}
      `}</style>
    </aside>
  );
}
