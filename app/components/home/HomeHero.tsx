  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        @media(max-width:760px){.homeHeroInner{width:calc(100% - 28px);padding:44px 0 65px}.heroCopy h1{margin-top:14px;font-size:35px;line-height:1.14;letter-spacing:-1.3px}.heroCopy>p{margin-top:18px;font-size:14px;line-height:1.68}.heroActions{margin-top:23px}.heroActions a{min-height:47px;padding:0 16px}.productExperience{margin-top:32px}.featuredBenefits{grid-template-columns:1fr}.featuredBenefits button{grid-column:auto}.valueCard{padding:16px 14px;grid-template-columns:48px 1fr}.valueCard p{font-size:12px}.valueCard strong{font-size:15px}.benefitsDropdown{grid-template-columns:1fr}}
      `}</style>
    </>
  );
}
