          ...
          <div className="heroLayout">
            ...
            <div className="productExperience">
              <div className="productSectionHead">
                <span>QR RETURN · 7 PRODUCTS</span>
                <h2>{ka ? "აირჩიეთ, რისი დაცვა გსურთ" : "Choose what you want to protect"}</h2>
                <p>{ka ? "თითოეული QR კოდი შესაბამის კატეგორიას უკავშირდება და საკუთარ ციფრულ პროფილს ქმნის." : "Each QR code connects to its category and creates a dedicated digital profile."}</p>
              </div>
              <ProductOrbit ka={ka} />
            </div>
          </div>
