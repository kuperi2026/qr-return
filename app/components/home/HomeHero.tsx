  ...
  return (
    <section className="homeHero">
      <div className="homeHeroInner">
        <div className="heroStage">
          ...
          <article className="ecosystemCircle">
            ...
            <div className="circleKeywords"><strong>Lost Mode</strong><strong>Live Chat</strong><strong>{ka ? "ზუსტი მდებარეობა" : "Precise location"}</strong></div>
          </article>
        </div>
      ...
      <style jsx>{`
        ...
        .eyebrow{color:#d3ebff;font-size:10px;font-weight:900;letter-spacing:1.6px}.ecosystemCircle h2{max-width:320px;margin:18px auto 0;color:#fff;font-size:clamp(25px,2.5vw,34px);line-height:1.17;letter-spacing:-1px}.circleKeywords{margin-top:24px;display:flex;justify-content:center;gap:7px;flex-wrap:wrap}.circleKeywords strong{padding:7px 9px;border:1px solid rgba(255,255,255,.3);border-radius:999px;color:#d4ecff;background:rgba(255,255,255,.08);font-size:9px}
        .stageAccent{width:66%;min-height:340px;margin-right:-25px;padding:44px 100px 44px 48px;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;border:1px solid rgba(255,255,255,.2);border-right:0;border-radius:34px 0 0 34px;background:rgba(2,44,87,.28);text-align:left}.stageAccent>span{color:#acd7fb;font-size:10px;font-weight:900;letter-spacing:2px}.stageAccent h1{max-width:690px;margin:14px 0 0;color:#fff;font-size:clamp(38px,4.4vw,62px);line-height:1.04;letter-spacing:-2.2px}.stageAccent h1 strong{color:#bfe4ff}.stageAccent p{max-width:720px;margin:24px 0 0;color:rgba(255,255,255,.83);font-size:clamp(16px,1.5vw,19px);line-height:1.68}.stageAccent p strong{color:#fff}.stageAccent p em{color:#c7e7ff;font-style:italic;font-weight:800}
        .detailCopy{margin-top:28px;padding:26px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;border:1px solid rgba(255,255,255,.22);border-radius:24px;background:rgba(2,44,87,.22)}.detailCopy p{max-width:none;margin:0;padding:17px;border:1px solid rgba(255,255,255,.13);border-radius:15px;color:rgba(255,255,255,.8);background:rgba(255,255,255,.055);font-size:14px;line-height:1.62}.detailCopy p:last-child{grid-column:1/-1}.detailCopy strong{color:#fff}.detailCopy em{color:#c8e8ff;font-style:italic;font-weight:800}
        ...
        @media(max-width:900px){.heroStage{min-height:auto;flex-direction:column;justify-content:center;gap:22px}.stageAccent{width:100%;min-height:auto;margin:0;padding:34px;border-right:1px solid rgba(255,255,255,.2);border-radius:24px}.ecosystemCircle{width:min(440px,76vw);padding:clamp(42px,8vw,58px)}.detailCopy{grid-template-columns:1fr}.detailCopy p:last-child{grid-column:auto}.productRail{display:flex;overflow-x:auto;padding:3px 2px 17px;scroll-snap-type:x proximity}.productItem{min-width:170px;scroll-snap-align:start}.productImage{height:150px}}
        @media(max-width:700px){.homeHero{padding:34px 14px 54px}.stageAccent{padding:27px}.stageAccent h1{font-size:36px;line-height:1.08}.stageAccent p{font-size:15px}.ecosystemCircle{width:100%;min-height:390px;aspect-ratio:auto;border-radius:50%;padding:45px 28px}.ecosystemCircle:after{width:16px;height:16px;top:42px;right:40px}.eyebrow{font-size:9px;letter-spacing:1.2px}.detailCopy{padding:14px}.detailCopy p{padding:14px;font-size:13px}.productShowcase{margin-top:34px;padding-top:24px}.productHeading{display:block;text-align:center}.productHeading h2{margin-top:10px;font-size:25px;text-align:center}.productRail{margin-top:19px}.productItem{min-width:150px}.heroActions{grid-template-columns:1fr;gap:10px;margin-top:18px}.heroActions a{min-height:58px}}
      `}</style>
    </section>
  );
}
