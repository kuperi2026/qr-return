  ...
  return (
    <section className="homeHero">
      ...
      <style jsx>{`
        ...
        .stageAccent{width:62%;height:270px;margin-left:-25px;padding:0 40px 0 95px;display:flex;flex-direction:column;align-items:center;justify-content:center;border:1px solid rgba(255,255,255,.2);border-left:0;border-radius:0 150px 150px 0;background:rgba(2,44,87,.28);text-align:center}.stageAccent span{color:rgba(255,255,255,.12);font-size:88px;font-weight:950;line-height:.8;letter-spacing:-8px}.stageAccent strong{margin-top:10px;font-size:clamp(28px,3.8vw,50px);letter-spacing:8px}.stageAccent small{margin-top:16px;color:#acd7fb;font-size:9px;font-weight:900;letter-spacing:1.7px}
        ...
        @media(max-width:900px){.heroStage{min-height:auto;justify-content:center}.ecosystemCircle{width:min(500px,76vw);padding:clamp(42px,8vw,58px)}.stageAccent{display:none}.productRail{display:flex;overflow-x:auto;padding:3px 2px 17px;scroll-snap-type:x proximity}.productItem{min-width:170px;scroll-snap-align:start}.productImage{height:150px}}
