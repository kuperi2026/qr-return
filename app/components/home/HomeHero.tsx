  ...
  return (
    <section className="homeHero">
      ...
      <style jsx>{`
        ...
        @media(max-width:700px){.homeHero{padding:34px 14px 54px}.stageAccent{padding:31px 23px}.stageAccent h2{font-size:29px}.stageAccent .leadCopy,.detailCopy p{font-size:17px;line-height:1.55;letter-spacing:-.2px}.ecosystemCircle{width:min(300px,82vw)}.productShowcase{margin-top:34px;padding-top:24px}.productHeading{display:block;text-align:center}.productHeading h2{margin-top:10px;font-size:25px;text-align:center}.productRail{margin-top:19px}.productItem{min-width:150px}.heroActions{grid-template-columns:1fr;gap:10px;margin-top:18px}.heroActions a{min-height:58px}}
      `}</style>
    </section>
  );
}
