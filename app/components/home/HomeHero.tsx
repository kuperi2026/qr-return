...
function InfoPanel({ eyebrow, title, items }: { eyebrow: string; title: string; items: Benefit[] }) {
  ...
  return (
    <aside className="infoPanel">
      ...
      <style jsx>{`
        .infoPanel{padding:23px 20px;border:1px solid rgba(255,255,255,.34);border-radius:20px;background:#fff;box-shadow:0 20px 48px rgba(23,25,35,.24)}.infoPanel>span{color:#2F3039;font-size:9px;font-weight:900;letter-spacing:1.3px}.infoPanel h2{margin:10px 0 0;color:#2F3039;font-size:21px;line-height:1.3}.accordion{margin-top:17px}.benefit{border-top:1px solid #DFDFE2}.benefit button{width:100%;min-height:49px;padding:10px 0;display:grid;grid-template-columns:23px 1fr 20px;align-items:center;gap:8px;border:0;background:transparent;color:#2F3039;text-align:left;cursor:pointer}.benefit button b{color:#63636C;font-size:8px}.benefit button strong{font-size:13px;font-weight:850;line-height:1.35}.benefit button i{width:20px;height:20px;display:grid;place-items:center;border:1px solid #B3B3BA;border-radius:50%;font-style:normal;font-size:14px}.benefit p{margin:-1px 0 13px;padding:0 0 0 31px;color:#63636C;font-size:12px;line-height:1.58}.benefit.open button i{border-color:#2F3039;background:#2F3039;color:#fff}.benefit.open button strong{color:#2F3039}@media(max-width:760px){.infoPanel{padding:20px}.infoPanel h2{font-size:20px}.benefit button strong{font-size:14px}.benefit p{font-size:13px}}
      `}</style>
    </aside>
  );
}
