...
export default function ProductOrbit({ ka }: { ka: boolean }) {
  return (
    <div className="productShowcase">
      ...
      <style jsx>{`
        .productShowcase{width:100%}.productGrid{display:grid;grid-template-columns:repeat(7,1fr);gap:10px}.productCard,.emergencyCard{min-height:174px;padding:15px 14px;display:flex;flex-direction:column;border-radius:18px}.productCard{border:1px solid rgba(255,255,255,.3);background:rgba(255,255,255,.1);color:#fff;backdrop-filter:blur(8px)}.emergencyCard{background:#fff;color:#2F3039;box-shadow:0 18px 42px rgba(23,25,35,.18)}.cardTop{display:flex;justify-content:space-between;align-items:center;color:rgba(255,255,255,.57);font-size:7px;font-weight:900;letter-spacing:1px}.emergencyCard .cardTop{color:#63636C}.cardTop b{font-size:8px}.emoji,.emergencyIcon{margin:auto 0 9px;width:52px;height:52px;display:grid;place-items:center;border-radius:15px;box-shadow:0 10px 20px rgba(23,25,35,.12)}.emoji{background:#fff;font-size:26px}.emergencyIcon{background:#2F3039;color:#fff}.productCard>strong,.emergencyCard>strong{font-size:15px}.productCard>small,.emergencyCard>small{margin-top:5px;font-size:7px;font-weight:850;letter-spacing:.25px;line-height:1.4}.productCard>small{color:rgba(255,255,255,.66)}.emergencyCard>small{color:#63636C}
