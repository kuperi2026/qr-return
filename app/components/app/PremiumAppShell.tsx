  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        body.kompasiAppRegistration .appRegistrationHero{width:min(520px,100%)!important;min-height:174px!important;margin:12px auto 10px!important;padding:15px!important;display:grid!important;grid-template-columns:132px minmax(0,1fr)!important;gap:16px!important;align-items:center!important;overflow:hidden!important;border:1px solid rgba(255,255,255,.52)!important;border-radius:22px!important;background:linear-gradient(145deg,#fff 0%,#eef7ff 100%)!important;box-shadow:0 18px 38px rgba(0,28,67,.24)!important;color:#113a61!important}
        body.kompasiAppRegistration .appRegistrationHeroImage{width:132px!important;height:142px!important;position:relative!important;overflow:hidden!important;border-radius:17px!important;background:linear-gradient(145deg,#eef6fb,#fff)!important}
        body.kompasiAppRegistration .appRegistrationHeroImage img{object-fit:contain!important;padding:5px!important}
        body.kompasiAppRegistration .appRegistrationHeroCopy span{display:inline-flex!important;padding:6px 9px!important;border-radius:999px!important;background:#e2f1ff!important;color:#0965bd!important;font-size:9px!important;font-weight:900!important;line-height:1.2!important}
        body.kompasiAppRegistration .appRegistrationHeroCopy h1{margin:8px 0 6px!important;color:#073b70!important;font-size:22px!important;font-weight:950!important;line-height:1.05!important;letter-spacing:-.5px!important}
        body.kompasiAppRegistration .appRegistrationHeroCopy p{margin:0!important;color:#4f6e88!important;font-size:10px!important;font-weight:750!important;line-height:1.55!important}
