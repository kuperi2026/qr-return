  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        body.kompasiAppMode .subscriptionsPage .calculatorLauncher{display:flex!important}
        body.kompasiAppMode .subscriptionsPage .calculatorOverlay{display:flex!important}
