  ...
  return (
    <>
      ...
      <nav className="appDock" aria-label="KOMPASI აპის ნავიგაცია">
        {NAV_ITEMS.map((item) => {
          const active = item.href === "/app/chat"
            ? pathname.startsWith("/app/chat") || pathname.startsWith("/account/chat") || pathname.startsWith("/support")
            : item.href === "/my-profiles" || item.href === "/app/dashboard"
              ? pathname === item.href
      ...
      <style jsx global>{`
        ...
        body.kompasiAppRegistration input,body.kompasiAppRegistration select{width:100%!important;max-width:100%!important;min-height:48px!important;padding:0 13px!important;border:1px solid #c9daeb!important;border-radius:13px!important;background:linear-gradient(135deg,#f7fbff,#f5f1ff)!important;color:#173652!important;font-size:13px!important;box-shadow:inset 0 1px 2px rgba(20,54,88,.04)!important;transition:border-color .18s,box-shadow .18s,background .18s!important}
        body.kompasiAppRegistration textarea{width:100%!important;max-width:100%!important;min-height:92px!important;padding:12px 13px!important;border:1px solid #cce0dc!important;border-radius:13px!important;background:linear-gradient(135deg,#f7fbff,#effaf5)!important;color:#173652!important;font-size:13px!important;line-height:1.5!important;resize:vertical!important;transition:border-color .18s,box-shadow .18s,background .18s!important}
        body.kompasiAppRegistration input::placeholder,body.kompasiAppRegistration textarea::placeholder{color:#91a3b4!important}
        body.kompasiAppRegistration input:focus,body.kompasiAppRegistration select:focus,body.kompasiAppRegistration textarea:focus{outline:0!important;border-color:#6c78da!important;background:#fff!important;box-shadow:0 0 0 4px rgba(108,120,218,.12)!important}
        body.kompasiAppRegistration input:disabled,body.kompasiAppRegistration select:disabled{background:linear-gradient(135deg,#edf2f7,#f2eef8)!important;color:#708397!important;opacity:1!important}
        body.kompasiAppRegistration label{color:#39566f!important;font-size:11px!important;font-weight:850!important}
        body.kompasiAppRegistration label>span,body.kompasiAppRegistration .fieldLabel{display:block!important;margin-bottom:6px!important;color:#36536d!important;font-size:11px!important;font-weight:900!important}
        body.kompasiAppRegistration label:nth-of-type(3n+2) input,body.kompasiAppRegistration label:nth-of-type(3n+2) select{border-color:#d7cdf0!important;background:linear-gradient(135deg,#fbf9ff,#f2edff)!important}
        body.kompasiAppRegistration label:nth-of-type(3n) input,body.kompasiAppRegistration label:nth-of-type(3n) select{border-color:#c8e1d8!important;background:linear-gradient(135deg,#f8fffc,#edf9f4)!important}
