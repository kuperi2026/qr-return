...
export default function RegistrationPage() {
  ...
  async function handleSubmit(
    ...
    try {
      /*
        ფოტოები უკვე აირჩევა UI-ში,
        მაგრამ Storage-ს შემდეგ ეტაპზე მივაბამთ.
      */
    ...
    return (
      <main className="page">
        ...
        <section className="successPage">
          ...
          <p>
            {ka
              ? "თქვენი ინფორმაცია შენახულია. პროფილის მონაცემების შეცვლას მოგვიანებითაც შეძლებთ."
          ...
          <div>
            ...
            <p>
              {ka
                ...
                : "Add information that will help a finder contact you if the pet or item is lost."}
            </p>
          </div>
        </div>
          ...
          {step === 1 && (
            <>
              <StepHeader
                ...
                description={
                  ka
                    ? "შეავსეთ ძირითადი ინფორმაცია. დამატებითი მონაცემების შევსება სურვილისამებრ შეგიძლიათ."
          ...
          {step === 2 && (
            <>
              <StepHeader
                ...
                description={
                  ka
                    ? "ეს ინფორმაცია დაგვეხმარება, რომ მპოვნელმა თქვენთან დაკავშირება შეძლოს."
                    : "This information helps the finder contact you."
                }
              />
          ...
          {step === 3 && (
            <>
              <StepHeader
                ...
                description={
                  ka
                    ? "ბოლო პარამეტრები — თქვენ აკონტროლებთ, რა შესაძლებლობები ექნება მპოვნელს."
                    : "Final settings — you control which options are available to the finder."
                }
              />
              ...
              <div className="settingCard">
                <div>
                  ...
                  <p>
                    {ka
                      ? "თუ ჩართავთ, QR კოდის დამსკანერებელს სურვილის შემთხვევაში შეეძლება თავისი მიმდინარე ლოკაციის გამოგზავნა. ლოკაცია ავტომატურად არ გაზიარდება."
                      : "When enabled, the person scanning the QR may choose to send their current location. Location is never shared automatically."}
                  </p>
                </div>
              ...
              <div className="summary">
                ...
                <div>
                  ...
                  <small>
                    {ka
                      ? "კატეგორიის შეცვლა პროფილის შექმნის შემდეგ შეუძლებელი იქნება. მონაცემების რედაქტირება კი ნებისმიერ დროს შეგეძლებათ."
                      : "The category cannot be changed after profile creation. Profile information can be edited later."}
                  </small>
                </div>
              </div>
