  ...
  if (loading) {
    return (
      <main className="statePage">
        ...
        <strong>
          {ka ? "Admin Dashboard იტვირთება..." : "Loading Admin Dashboard..."}
        </strong>
  ...
  if (!isAdmin) {
    return (
      <main className="statePage">
        ...
        <h1>
          {ka ? "Admin წვდომაა საჭირო" : "Admin access required"}
        </h1>
        ...
        <a href="/login">
          {ka ? "Admin ანგარიშით შესვლა" : "Sign in as Admin"}
        </a>
    ...
    <main className="page">
      ...
      <section className="dashboard">
        <div className="intro">
          ...
          <h1>
            {ka ? "Admin Dashboard" : "Admin Dashboard"}
          </h1>
        ...
        <div className="grid">
          ...
          >
            ...
            <h2>
              {ka ? "Support Inbox" : "Support Inbox"}
            </h2>
        ...
        <div className="quickActions">
          ...
          <a href="/">
            ← {ka ? "მთავარ გვერდზე დაბრუნება" : "Back to website"}
          </a>
        </div>
      </section>
