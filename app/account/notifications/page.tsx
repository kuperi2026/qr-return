  ...
  return (
    <main className="page accountNotificationsPage">
      ...
      <div className="shell">
        ...
        <section className="newsSummary" aria-label={ka ? "აქტივობის მოკლე შეჯამება" : "Activity summary"}>
          <div className="scan"><span>⌁</span><b>{scanCount}</b><small>{ka ? "სკანირება" : "Scans"}</small></div>
      ...
      <style jsx global>{`
        ...
        body.kompasiAppMode .accountNotificationsPage .shell>.list,body.kompasiAppMode .accountNotificationsPage .filters{display:none!important}
        ...
        body.kompasiAppMode .accountNotificationsPage .appNotificationGroups{margin-top:10px!important;gap:6px!important}.accountNotificationsPage .notificationGroup{border-radius:13px!important;box-shadow:0 4px 12px rgba(4,48,94,.06)!important}.accountNotificationsPage .notificationGroupButton{min-height:54px!important;padding:7px 9px!important;gap:8px!important}.accountNotificationsPage .notificationGroupIcon{width:36px!important;height:36px!important;flex-basis:36px!important;border-radius:11px!important;font-size:17px!important}.accountNotificationsPage .notificationGroupCopy b{overflow:hidden;font-size:12px!important;text-overflow:ellipsis;white-space:nowrap}.accountNotificationsPage .notificationGroupButton>strong{min-width:28px!important;height:28px!important;border-radius:9px!important;font-size:12px!important}.accountNotificationsPage .notificationGroupButton>i{width:24px!important;height:24px!important;border-radius:8px!important;font-size:11px!important}.accountNotificationsPage .notificationGroupBody{padding:6px!important;gap:5px!important}.accountNotificationsPage .notificationGroupBody .card{min-height:58px!important;padding:9px!important}.accountNotificationsPage .notificationGroupBody .icon{width:34px!important;height:34px!important;font-size:15px!important}
.newsSummary{margin-top:10px;display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.newsSummary>div{min-width:0;padding:9px 5px;display:grid;grid-template-columns:25px 1fr;grid-template-rows:auto auto;column-gap:5px;align-items:center;border-radius:12px;color:#183b59;box-shadow:0 5px 14px rgba(5,45,87,.08)}.newsSummary span{grid-row:1/3;width:25px;height:25px;display:grid;place-items:center;border-radius:8px;background:rgba(255,255,255,.72);font-size:13px}.newsSummary b{font-size:14px;line-height:1}.newsSummary small{margin-top:2px;overflow:hidden;font-size:7px;font-weight:800;text-overflow:ellipsis;white-space:nowrap}.newsSummary .scan{background:#e9e4ff}.newsSummary .chat{background:#dceeff}.newsSummary .location{background:#dcf5e8}.newsSummary .order{background:#fff0df}body.kompasiAppMode .accountNotificationsPage .newsSummary{display:none!important}
                body.kompasiAppMode .accountNotificationsPage{background:radial-gradient(circle at 88% 0%,rgba(27,197,157,.2),transparent 24%),radial-gradient(circle at 5% 8%,rgba(45,119,255,.34),transparent 30%),linear-gradient(180deg,#061a31 0,#0a355c 280px,#edf4f8 280px)!important}
        body.kompasiAppMode .accountNotificationsPage .notificationHero{border-color:rgba(122,190,255,.3)!important;background:linear-gradient(145deg,rgba(15,77,133,.9),rgba(6,35,68,.94) 55%,rgba(7,91,78,.88))!important;box-shadow:0 22px 55px rgba(1,18,38,.38),inset 0 1px 0 rgba(255,255,255,.18)!important}
        body.kompasiAppMode .accountNotificationsPage .heroBell{border-color:rgba(255,255,255,.28)!important;background:linear-gradient(145deg,#1978e8,#0aa369)!important;box-shadow:0 9px 22px rgba(0,22,48,.3)!important}
        body.kompasiAppMode .accountNotificationsPage .unreadBadge{background:linear-gradient(145deg,#fff,#eaf7ff)!important;box-shadow:0 10px 24px rgba(0,18,40,.28)!important}
        body.kompasiAppMode .accountNotificationsPage .newsSummary>div{min-height:62px;padding:10px 7px;color:#fff;box-shadow:0 10px 24px rgba(4,29,55,.2),inset 0 1px 0 rgba(255,255,255,.24)}
        body.kompasiAppMode .accountNotificationsPage .newsSummary span{background:rgba(255,255,255,.18);color:#fff;box-shadow:inset 0 0 0 1px rgba(255,255,255,.16)}
        body.kompasiAppMode .accountNotificationsPage .newsSummary b{color:#fff;font-size:17px}
        body.kompasiAppMode .accountNotificationsPage .newsSummary small{color:rgba(255,255,255,.84)}
        body.kompasiAppMode .accountNotificationsPage .newsSummary .scan{background:linear-gradient(145deg,#4939b8,#7561e8)}
        body.kompasiAppMode .accountNotificationsPage .newsSummary .chat{background:linear-gradient(145deg,#075fbd,#1595c9)}
        body.kompasiAppMode .accountNotificationsPage .newsSummary .location{background:linear-gradient(145deg,#05734f,#0faf78)}
        body.kompasiAppMode .accountNotificationsPage .newsSummary .order{background:linear-gradient(145deg,#ae5812,#e59127)}
        body.kompasiAppMode .accountNotificationsPage .notificationGroup{border:1px solid #cfdeea!important;background:linear-gradient(145deg,#fff,#f9fcff)!important;box-shadow:0 10px 26px rgba(5,40,76,.1)!important}
        body.kompasiAppMode .accountNotificationsPage .notificationGroupButton{background:transparent!important}
        body.kompasiAppMode .accountNotificationsPage .notificationGroupCopy b{color:#102f49!important}
        body.kompasiAppMode .accountNotificationsPage .notificationGroupCopy small{color:#607c92!important}
        body.kompasiAppMode .accountNotificationsPage .group-unread{border-left:4px solid #e47830!important}
        body.kompasiAppMode .accountNotificationsPage .group-chat{border-left:4px solid #1678dc!important}
        body.kompasiAppMode .accountNotificationsPage .group-scan{border-left:4px solid #6954d8!important}
        body.kompasiAppMode .accountNotificationsPage .group-location{border-left:4px solid #0aa369!important}
        body.kompasiAppMode .accountNotificationsPage .group-order{border-left:4px solid #d98218!important}
