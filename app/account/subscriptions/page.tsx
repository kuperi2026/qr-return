  ...
  return <main className="subscriptionsPage" data-app-step={appStep}>
    ...
    <section className="shell">
      ...
      <section className="appTariffHeader">
        ...
        <Link className="appVideoGuide" href="/app/guides"><span>▶</span><div><b>ვიდეო ინსტრუქცია</b><small>კალენდარი · ვადები · შეძენა</small></div><i>ნახვა ›</i></Link>
    ...
    <style jsx>{`
      ...
      body.kompasiAppMode .appVideoGuide{min-height:68px;padding:11px 13px;border-color:#d9e8f7;background:#fff;color:#173d60;box-shadow:0 10px 24px rgba(4,42,91,.2)}body.kompasiAppMode .appVideoGuide>span{width:43px;height:43px;flex-basis:43px;border-radius:14px;background:#0870d8;color:#fff;box-shadow:0 7px 15px rgba(8,112,216,.25)}body.kompasiAppMode .appVideoGuide>div{min-width:0;display:grid;gap:3px}body.kompasiAppMode .appVideoGuide>div b{font-size:13px}body.kompasiAppMode .appVideoGuide>div small{color:#71889d;font-size:9px;font-weight:750}body.kompasiAppMode .appVideoGuide>i{margin-left:auto;padding:8px 10px;border-radius:10px;background:#eaf4ff;color:#0870d8;font-size:10px;font-weight:950;white-space:nowrap}
    `}</style>
  </main>;
}
