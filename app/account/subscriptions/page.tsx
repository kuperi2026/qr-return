...
export default function SubscriptionsPage() {
  ...
  return <main className="subscriptionsPage">
    ...
    <style jsx>{`
      ...
      :global(html),:global(body){min-height:100%;background:#eef0f1}.subscriptionsPage{background:linear-gradient(145deg,#e7e9ea 0%,#f1f2f2 48%,#fafafa 100%)}.topbar{background:transparent}.prices{margin-bottom:26px}
    `}</style>
  </main>;
}
