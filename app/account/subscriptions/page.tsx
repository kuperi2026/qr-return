...
export default function SubscriptionsPage() {
  ...
  return <main className="subscriptionsPage" data-app-step={appStep}>
    ...
    <section className="shell">
      ...
      <div className="layout">
        <section className="panel">
          ...
          <details className="inlineCalculator">
            <summary><span><small>ფასების ინსტრუქცია</small><b>ფასის კალკულატორი</b></span><strong>{selectedItems.length ? `${total} ₾` : "გახსნა"}<i>⌄</i></strong></summary>
    ...
    <style jsx>{`
      .appCheckoutSteps,.appNext,.appStageActions,.summaryPrevious,.appPriceCatalog,.inlineCalculator{display:none}
