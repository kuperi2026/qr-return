...
export default function SubscriptionsPage() {
  ...
  return <main className="subscriptionsPage">
    ...
    <style jsx>{`
      ...
      .subscriptionsPage{background:#fff;color:#17314d}.topbar{width:100%;max-width:none;padding:0 max(24px,calc((100% - 1260px)/2));border-bottom:1px solid #dce6ef;background:#fff}.brand{color:#17314d}.brand>span{background:#1266e9;color:#fff}.brand small{color:#718397}.back{border-color:#dce6ef;background:#f6f9fd;color:#31516d}.shell{max-width:1260px;margin-top:25px}.intro{color:#17314d}.intro small{color:#1266e9}.intro h1{color:#17314d;font-size:32px}.intro p{color:#60758a;font-size:15px}.free{border:0;background:linear-gradient(135deg,#0647c8,#1675ed);color:#fff;box-shadow:none}.free span{color:#d9ecff}.layout{grid-template-columns:minmax(0,1fr) 310px;padding:18px;border:1px solid #dce7f2;border-radius:18px;background:#f7faff}.panel{padding:2px;border:0;background:transparent;box-shadow:none}.profiles{grid-template-columns:repeat(2,minmax(0,1fr))}.summary{padding:20px;border:0;border-radius:15px;background:#082f59;color:#fff;box-shadow:none}.summary>small{color:#79b8ff}.summary h2{color:#fff}.chosen{background:rgba(255,255,255,.08)}.chosen>div{border-color:rgba(255,255,255,.13);color:#fff}.line{border-color:rgba(255,255,255,.14);color:#c7e2f8}.line b{color:#fff}.total{background:#fff}.summary button{background:#fff;color:#0647c8;box-shadow:none}.summary p{color:#c7e2f8}.prices{margin-top:15px;border-radius:15px;box-shadow:none}.prices>div>small{color:#1266e9}
