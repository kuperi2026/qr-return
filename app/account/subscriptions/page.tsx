...
export default function SubscriptionsPage() {
  ...
  return <main className="subscriptionsPage" data-app-step={appStep}>
    ...
    <style jsx>{`
      ...
      .priceCalendarHead{font-size:9px!important}.priceCalendar article>button{font-size:12px!important}
    `}</style>
  </main>;
}
