  ...
  return (
    <main className="page ownerChatPage">
      ...
      <style jsx global>{`
        ...
        body.kompasiAppMode .ownerChatPage .inbox{border:1px solid #b9d3e7!important;border-radius:18px!important;background:#e7f1f9!important;box-shadow:0 8px 24px rgba(13,55,96,.12)!important}.ownerChatPage .sidebar,.ownerChatPage .chatPanel{background:#e7f1f9!important}.ownerChatPage .sidebarTitle,.ownerChatPage .chatHeader{background:#d9eaf7!important}
