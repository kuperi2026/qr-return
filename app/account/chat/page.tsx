...
export default function OwnerChatInboxPage() {
  ...
  useEffect(() => {
    ...
    return () => {
      document.body.classList.remove("kompasiChatOpen");
  ...
  async function shareOwnerLocation() {
    ...
    try {
      ...
      const message = denied
        ? (ka ? "ლოკაციის ნებართვა საჭიროა." : "Location permission is required.")
        : (ka ? "ლოკაცია ვერ განისაზღვრა." : "Location could not be determined.");
  ...
  return (
    <main className={`page ownerChatPage theme-${chatTheme}`}>
              ...
              <>
                ...
                >
                  <div className="composerTools">
                    ...
                    <div className={`compactThemePicker ${themeOpen ? "open" : ""}`}>
                      <button type="button" className={`themeToggle ${chatTheme}`} onClick={() => setThemeOpen((value) => !value)} aria-label={ka ? "ჩათის ფერის შეცვლა" : "Change chat color"} />
                      {themeOpen && <div className="themeOptions">
      ...
      <Styles />
      <style jsx global>{`
        .compactThemePicker{position:relative;order:3}.compactThemePicker button{width:40px;height:40px;padding:0;border:3px solid #fff;border-radius:50%;box-shadow:0 0 0 1px #c7d5e2;cursor:pointer}.compactThemePicker .blue{background:linear-gradient(135deg,#126bd1,#dceeff)}.compactThemePicker .ocean{background:linear-gradient(135deg,#087a58,#c9f0df)}.compactThemePicker .violet{background:linear-gradient(135deg,#7254c7,#e6dcff)}.compactThemePicker .red{background:linear-gradient(135deg,#bd252c,#ffd5d7)}.themeOptions{position:absolute;left:0;bottom:48px;z-index:30;padding:7px;display:grid;gap:7px;border-radius:22px;background:#fff;box-shadow:0 10px 28px rgba(14,54,92,.2)}
        .ownerChatPage.theme-blue{background:linear-gradient(155deg,#0757a6 0%,#78b9eb 24%,#e3f1fb 52%,#fff 82%)!important}.ownerChatPage.theme-ocean{background:linear-gradient(155deg,#087a58 0%,#70cba6 26%,#e3f6ee 57%,#fff 84%)!important}.ownerChatPage.theme-violet{background:linear-gradient(155deg,#5642a4 0%,#a696dd 25%,#eeeafd 58%,#fff 84%)!important}.ownerChatPage.theme-red{background:linear-gradient(155deg,#9f1e24 0%,#d96569 25%,#f7dddd 58%,#fff 84%)!important}
        .ownerChatPage.theme-blue .messageRow.mine .bubble{background:linear-gradient(135deg,#075fbd,#1584cf)!important}.ownerChatPage.theme-ocean .messageRow.mine .bubble{background:linear-gradient(135deg,#087a58,#159b79)!important}.ownerChatPage.theme-violet .messageRow.mine .bubble{background:linear-gradient(135deg,#6247b2,#8565d2)!important}.ownerChatPage.theme-red .messageRow.mine .bubble{background:linear-gradient(135deg,#a61f26,#cf3c42)!important}
        .ownerChatPage.theme-blue .chatPanel{background:#e8f3fc!important}.ownerChatPage.theme-blue .chatHeader{background:linear-gradient(90deg,#c8e4f8,#eef6fc)!important}.ownerChatPage.theme-blue .messages{background:linear-gradient(155deg,#d7ebf8 0%,#eaf5fb 48%,#f8fcff 100%)!important}.ownerChatPage.theme-blue .composer{background:#e1eff9!important}
        .ownerChatPage.theme-ocean .chatPanel{background:#e5f6f3!important}.ownerChatPage.theme-ocean .chatHeader{background:linear-gradient(90deg,#bfe8e1,#eef9f7)!important}.ownerChatPage.theme-ocean .messages{background:linear-gradient(155deg,#ccece6 0%,#e8f7f4 50%,#fbfefd 100%)!important}.ownerChatPage.theme-ocean .composer{background:#d9f0eb!important}
        .ownerChatPage.theme-violet .chatPanel{background:#f0ecfb!important}.ownerChatPage.theme-violet .chatHeader{background:linear-gradient(90deg,#ddd4f7,#f5f2fc)!important}.ownerChatPage.theme-violet .messages{background:linear-gradient(155deg,#e2daf8 0%,#f1edfb 50%,#fdfcff 100%)!important}.ownerChatPage.theme-violet .composer{background:#eae4f8!important}
        .ownerChatPage.theme-red .chatPanel{background:#fae9ea!important}.ownerChatPage.theme-red .chatHeader{background:linear-gradient(90deg,#efbfc1,#fff0f0)!important}.ownerChatPage.theme-red .messages{background:linear-gradient(155deg,#efc7c9 0%,#f8e3e4 50%,#fff9f9 100%)!important}.ownerChatPage.theme-red .composer{background:#f2d4d6!important}
        .ownerChatPage .sender{font-size:15px!important;font-weight:900!important;line-height:1.35!important}.ownerChatPage .messageText{font-size:16px!important;line-height:1.5!important}
        body.kompasiAppMode{background:#f7fbfc!important}
        .ownerChatPage{font-family:"Noto Sans Georgian",Inter,"Segoe UI",Arial,"Sylfaen",sans-serif!important;background:radial-gradient(circle at 88% 8%,rgba(117,88,214,.14),transparent 25%),radial-gradient(circle at 10% 70%,rgba(31,190,147,.14),transparent 30%),linear-gradient(155deg,#087f91 0%,#6fc6cb 22%,#d9f0ef 48%,#ffffff 78%)!important}
        .ownerChatPage .operatorCard{margin-bottom:8px!important;padding:10px 13px!important;border:0!important;border-radius:15px!important;background:#084c8d!important;box-shadow:none!important}
        .ownerChatPage .inbox{border:1px solid rgba(255,255,255,.78)!important;border-radius:18px!important;background:rgba(255,255,255,.84)!important;box-shadow:0 12px 32px rgba(4,75,88,.16)!important;backdrop-filter:blur(14px)!important}.ownerChatPage .sidebar,.ownerChatPage .chatPanel{background:rgba(248,253,253,.9)!important}.ownerChatPage .sidebarTitle,.ownerChatPage .chatHeader{background:linear-gradient(90deg,#dff4f1,#eef1fb)!important}.ownerChatPage .thread{background:rgba(255,255,255,.76)!important}.ownerChatPage .thread:nth-child(3n+2){background:rgba(237,249,245,.9)!important}.ownerChatPage .thread.active{background:linear-gradient(90deg,#ccefeb,#e7e2f7)!important}
        .ownerChatPage .thread{min-height:76px!important;padding:10px 46px 10px 11px!important;border-color:#e7edf3!important}.ownerChatPage .thread.active{background:#eaf4ff!important}.ownerChatPage .threadIcon{width:46px!important;height:46px!important;flex-basis:46px!important;border-radius:14px!important}.ownerChatPage .threadTop strong{font-size:14px!important}.ownerChatPage .thread p{font-size:12px!important;line-height:1.35!important}
        .ownerChatPage .messages{background:linear-gradient(160deg,#edf9f7 0%,#f7f5fc 52%,#ffffff 100%)!important}.ownerChatPage .bubble{border-radius:17px 17px 17px 5px!important;background:#fff!important;color:#20364a!important;font-size:15px!important;line-height:1.45!important;box-shadow:0 2px 8px rgba(22,78,85,.1)!important}.ownerChatPage .messageRow.mine .bubble{border-radius:17px 17px 5px 17px!important;background:linear-gradient(135deg,#087f91,#159b79)!important;color:#fff!important;box-shadow:none!important}.ownerChatPage .messageMeta time{font-size:12px!important}.ownerChatPage .messageMeta span{font-size:11px!important}
        .ownerChatPage .composer textarea{border:1px solid #dbe4ec!important;border-radius:16px!important;background:#f7f9fb!important;font-size:15px!important}.ownerChatPage .composer .sendButton{border-radius:14px!important;background:#0a67c7!important}.ownerChatPage .aiReception{display:block!important}.aiLanguage{margin-top:9px}.aiLanguage>span{display:block;margin-bottom:5px;color:#566e84;font-size:9px;font-weight:900}.aiLanguage>div{display:grid;grid-template-columns:1fr 1fr;gap:6px}.aiLanguage button{min-height:36px;border:1px solid #c9dced;border-radius:9px;background:#fff;color:#075dcc;font-size:10px;font-weight:900;cursor:pointer}
        .deleteChat{width:36px;height:36px;display:grid;place-items:center;flex:0 0 36px;border:1px solid #ffd1d1;border-radius:11px;background:#fff2f2;color:#c53636;font-size:18px;cursor:pointer}.messageFooter{max-width:78%;margin-top:4px;display:flex;align-items:center;justify-content:flex-end;gap:6px}.messageFooter .messageMeta{margin:0}.editMessage{width:25px;height:25px;margin:0;padding:0;display:grid;place-items:center;border:1px solid #cbd9e6;border-radius:50%;background:rgba(255,255,255,.82);color:#3271ad;line-height:1;cursor:pointer}.editMessage svg{width:14px;height:14px;display:block}.cancelEdit{width:42px;min-height:48px;border:1px solid #d6e0e8;border-radius:14px;background:#fff;color:#64788a;font-size:22px}.threadTop small{display:block;margin-top:3px;color:#668096;font-size:11px;font-weight:750}.liveStatus{max-width:150px;line-height:1.25;text-align:center}
        .conversationTabs{display:none!important}
        .ownerChatPage>.container>.errorBox{display:none!important}
        ...
        .ownerChatPage .composerTools>.emojiWrap{order:1}.ownerChatPage .composerTools>.mediaButton:nth-of-type(1){order:2}.ownerChatPage .composerTools>.mediaButton:nth-of-type(2){order:4}.ownerChatPage .composerTools>.locationButton{order:5}
        .ownerChatPage .inbox.mobileChatOpen .chatPanel .composer{bottom:18px!important;background:transparent!important}
