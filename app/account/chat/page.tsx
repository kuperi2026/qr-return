...
export default function OwnerChatInboxPage() {
  ...
  return (
    <main className="page ownerChatPage">
      ...
      <Styles />
      <style jsx global>{`
        body.kompasiAppMode{background:#dcecf8!important}
        body.kompasiAppMode .ownerChatPage{font-family:"Noto Sans Georgian","Sylfaen",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;background:linear-gradient(180deg,#cfe5f6 0%,#e4f0f9 48%,#dcecf8 100%)!important}
        ...
        html body.kompasiAppMode .ownerChatPage .inbox{border:1px solid #a9c9df!important;border-radius:18px!important;background:#d9eaf6!important;box-shadow:0 8px 24px rgba(13,55,96,.12)!important}html body.kompasiAppMode .ownerChatPage .sidebar,html body.kompasiAppMode .ownerChatPage .chatPanel{background:#d9eaf6!important}html body.kompasiAppMode .ownerChatPage .sidebarTitle,html body.kompasiAppMode .ownerChatPage .chatHeader{background:#c7dff0!important}html body.kompasiAppMode .ownerChatPage .thread{background:#e5f1f9!important}html body.kompasiAppMode .ownerChatPage .thread.active{background:#bddcf2!important}
