  ...
  return (
    <main className={`page ownerChatPage theme-${chatTheme}`}>
      ...
      <style jsx global>{`
        ...
        @media(max-width:800px){body.kompasiAppMode.kompasiChatOpen{height:100dvh!important;overflow:hidden!important}body.kompasiAppMode .ownerChatPage{height:calc(100dvh - 82px)!important;min-height:0!important;overflow:hidden!important;overscroll-behavior:none!important}body.kompasiAppMode .ownerChatPage .container{width:calc(100% - 16px)!important;height:100%!important;min-height:0!important;padding:10px 0 8px!important;display:flex!important;flex-direction:column!important;overflow:hidden!important}.ownerChatPage .operatorCard{min-height:64px!important;flex:0 0 64px!important;margin-bottom:8px!important}.ownerChatPage .operatorCopy strong{font-size:13px!important}.ownerChatPage .operatorCopy span{font-size:9px!important}.ownerChatPage .pageTitle{display:none!important}.ownerChatPage .inbox{height:auto!important;min-height:0!important;flex:1 1 auto!important;overflow:hidden!important}.ownerChatPage .sidebar,.ownerChatPage .chatPanel{height:100%!important;min-height:0!important;overflow:hidden!important}.ownerChatPage .sidebar{display:flex!important;flex-direction:column!important}.ownerChatPage .inbox.mobileChatOpen .sidebar{display:none!important}.ownerChatPage .sidebarTitle,.ownerChatPage .conversationTabs,.ownerChatPage .aiReception{flex:0 0 auto!important}.ownerChatPage .threadList{max-height:none!important;height:auto!important;min-height:0!important;flex:1 1 0!important;overflow-y:auto!important;overscroll-behavior:contain!important}.ownerChatPage .inbox.mobileChatOpen .chatPanel{height:100%!important;min-height:0!important;display:flex!important;flex-direction:column!important}.ownerChatPage .chatHeader{position:relative!important;top:auto!important;flex:0 0 68px!important}.ownerChatPage .messages{height:auto!important;min-height:0!important;flex:1 1 0!important;padding-bottom:70px!important;overflow-y:auto!important;overscroll-behavior:contain!important}.ownerChatPage .inbox.mobileChatOpen .composer{position:fixed!important;right:auto!important;bottom:84px!important;left:50%!important;z-index:800!important;width:min(504px,calc(100% - 16px))!important;height:60px!important;margin:0!important;padding:6px 7px!important;display:grid!important;grid-template-columns:36px 36px minmax(0,1fr) 36px 36px 44px!important;align-items:center!important;gap:5px!important;transform:translateX(-50%)!important;border:0!important;border-radius:0 0 18px 18px!important;background:rgba(239,247,252,.94)!important;box-shadow:none!important;backdrop-filter:blur(10px)!important}.ownerChatPage .composerTools,.ownerChatPage .composerInputRow{display:contents!important}.ownerChatPage .composerTools>.emojiWrap{grid-column:1}.ownerChatPage .composerTools>.mediaButton:nth-of-type(1){grid-column:2}.ownerChatPage .composerInputRow>textarea{grid-column:3;grid-row:1}.ownerChatPage .composerTools>.mediaButton:nth-of-type(2){grid-column:4;margin-left:0!important}.ownerChatPage .composerTools>.locationButton{grid-column:5}.ownerChatPage .composerInputRow>.sendButton{grid-column:6;grid-row:1}.ownerChatPage .composer .emojiButton,.ownerChatPage .composer .mediaButton,.ownerChatPage .composer .locationButton{width:36px!important;min-height:36px!important}.ownerChatPage .composer textarea{width:100%!important;height:44px!important;min-height:44px!important;max-height:44px!important;padding:11px 12px!important;overflow-y:auto!important;resize:none!important}.ownerChatPage .composer .sendButton{width:44px!important;min-height:44px!important}.ownerChatPage .composerInputRow>.cancelEdit{grid-column:3;grid-row:1;justify-self:end;z-index:2;width:34px!important;min-height:34px!important;margin-right:4px!important}}
      `}</style>
    </main>
  );
}
