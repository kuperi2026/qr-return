                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="bubble">
                            ...
                            {mine && <button type="button" className="editMessage" aria-label={ka ? "შეტყობინების რედაქტირება" : "Edit message"} title={ka ? "რედაქტირება" : "Edit"} onClick={() => { setEditingId(message.id); setText(message.message_text); }}>✎</button>}
                          </div>
                        </div>
                      );
                    })
