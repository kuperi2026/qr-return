...
async function uploadImage(
  ...
  const filePath = `${folder}/${cleanTag(
    tagCode
  ...
  async function handleSubmit(
    ...
    try {
      ...
      const payload = {
        ...
        weight:
          category.isPet && form.weight.trim()
            ? Number(form.weight)
            : null,
      ...
      <section className="content">
        <div className="intro">
          ...
          <div>
            ...
            <p>
              {ka
                ? "შეავსეთ ინფორმაცია და თავად გადაწყვიტეთ რომელი არასავალდებულო მონაცემი გამოჩნდება მპოვნელისთვის."
                : "Enter the information and choose which optional details the finder can see."}
            </p>
          </div>
        </div>
          ...
          {step === 1 && (
            <>
              <StepTitle
                ...
                text={
                  ka
                    ? "ძირითადი ინფორმაცია და მპოვნელისთვის ჩვენების პარამეტრები."
                    : "Basic information and finder visibility settings."
                }
              />
          ...
          {step === 2 && (
            <>
              <StepTitle
                ...
                text={
                  ka
                    ? "მიუთითეთ საკონტაქტო ინფორმაცია და აირჩიეთ დაკავშირების მეთოდები."
                    : "Enter contact details and choose how the finder may contact you."
                }
              />
              ...
              <div className="contactMethods">
                ...
                <ContactChoice
                  ...
                  text={
                    ka
                      ? "გამოიყენებს მითითებულ მობილურის ნომერს."
            ...
            <>
              ...
              <div className="locationCard">
                <div>
                  ...
                  <p>
                    {ka
                      ? "თუ ჩართავთ, მპოვნელს სურვილის შემთხვევაში შეეძლება თავისი მიმდინარე ლოკაციის გამოგზავნა. ავტომატურად არაფერი იგზავნება."
              ...
              <div className="summary">
                ...
                <section>
                  ...
                  <p>
                    {ka
                      ? "QR კოდი და კატეგორია უცვლელი დარჩება. დანარჩენი ინფორმაციის რედაქტირება მოგვიანებითაც შეგეძლებათ."
                      : "The QR code and category remain fixed. Other profile information can be edited later."}
                  </p>
                </section>
              </div>
