...
export default function HomeMegaMenu({
    ...
    return (
      <section className="megaMenu">
        <div className="megaInner aboutGrid">
          {/* FOUNDER */}
          <article className="founderBlock" id="founder">
            <div className="label">
              <span>01</span>
            ...
            {ka ? (
              <div className="founderText">
                <p className="lead">
                  ...
                  მნიშვნელოვან ნივთს, საყვარელ ცხოველს, ან როდესაც ოჯახის
                  წევრს გადაუდებელ სიტუაციაში დახმარება სჭირდება და მის
                  შესახებ აუცილებელი ინფორმაცია ხელმისაწვდომი არ არის?
                </p>

                <p>
                  ხშირად მპოვნელს დახმარება ნამდვილად სურს, მაგრამ არ იცის,
                  ვის დაუკავშირდეს. დაკარგულ ცხოველს არ შეუძლია პატრონის
                  ვინაობის თქმა, ნივთზე კი, როგორც წესი, არ არსებობს
                  ინფორმაცია, რომელიც მის დაბრუნებას გაამარტივებს.
                </p>

                <p>
                  Emergency სამაჯურის შემთხვევაში შეიძლება თითოეულ წუთსაც
                  დიდი მნიშვნელობა ჰქონდეს — განსაკუთრებით მაშინ, როდესაც
                  ადამიანი ვერ ახერხებს საკუთარი სახელის, ჯანმრთელობის
                  მდგომარეობის ან ოჯახის წევრის საკონტაქტო ინფორმაციის
                  თქმას.
                </p>

                <p>
                  სწორედ ამ პრობლემებზე ფიქრისას გაჩნდა QR RETURN-ის შექმნის
                  იდეა — შეგვექმნა ერთი მარტივი და უსაფრთხო სისტემა, რომელიც
                  საჭირო მომენტში ადამიანებს ერთმანეთთან სწრაფად
                  დააკავშირებდა.
                </p>

                <div className="highlight">
                  QR RETURN აერთიანებს დაკარგული ნივთების დაბრუნებას,
                  საყვარელი ცხოველების დაცვას და ადამიანებისთვის განკუთვნილ
                  Emergency პროფილებს.
                </div>

                <p>
                  QR კოდის დასკანერებით მპოვნელს ან დამხმარე ადამიანს შეუძლია
                  სწრაფად ნახოს მხოლოდ ის ინფორმაცია, რომლის გაზიარებაც
                  მომხმარებელს წინასწარ აქვს არჩეული, და დაუკავშირდეს
                  მფლობელს, ოჯახის წევრს ან საგანგებო საკონტაქტო პირს.
                </p>

                <p>
                  ამ პროდუქტის მნიშვნელობა მხოლოდ QR კოდში არ არის. მისი
                  მთავარი ღირებულება არის სწრაფად აღმოჩენილი კავშირი მაშინ,
                  როდესაც დრო, უსაფრთხოება და სწორი ინფორმაცია ყველაზე მეტად
                  გვჭირდება.
                </p>

                <p>
                  ჩემთვის განსაკუთრებით მნიშვნელოვანია, რომ მომხმარებელი
                  თავად აკონტროლებდეს საკუთარ ინფორმაციას — რას აჩვენებს, ვის
                  აჩვენებს და რა გზით შეიძლება მასთან დაკავშირება. ამიტომ QR
                  RETURN-ის საფუძველია არა მხოლოდ სიმარტივე, არამედ
                  უსაფრთხოება, კონფიდენციალურობა და ნდობა.
                </p>

                <p>
                  QR RETURN ჩემთვის უბრალოდ პროდუქტი ან ტექნოლოგიური
                  პლატფორმა არ არის. ეს არის იდეა, რომელსაც რეალურ ცხოვრებაში
                  ადამიანებისთვის სიმშვიდის, დაცულობისა და დახმარების მოტანა
                  შეუძლია.
                </p>

                <p>
                  ჩემი მიზანია, QR RETURN გახდეს პატარა, მაგრამ მნიშვნელოვანი
                  დამცავი რგოლი ადამიანებს, მათ საყვარელ ცხოველებსა და მათთვის
                  ძვირფას ნივთებს შორის — რადგან ზოგჯერ დასაბრუნებლად მხოლოდ
                  ერთი სწორი კავშირია საჭირო.
                </p>
              ...
              <div className="founderText">
                <p className="lead">
                  ...
                  or when essential information is unavailable during an
                  emergency?
                </p>

                <p>
                  QR RETURN was created as a simple and secure system that
                  helps establish the right connection when it matters most.
                </p>
          ...
          <div className="side">
            ...
            <article className="card" id="mission">
              ...
              <p>
                {ka
                  ...
                  : "Our mission is to create a simple and secure connection between the finder and the owner through one QR scan."}
              </p>
            </article>
            ...
            <article className="card" id="vision">
              ...
              <h3>
                {ka
                  ? "ერთი უნივერსალური სისტემა ნივთებისთვის, ცხოველებისა და ადამიანებისთვის."
                  : "One universal system for belongings, pets and people."}
              </h3>

              <p>
                {ka
                  ? "ჩვენი ხედვაა QR RETURN გახდეს უნივერსალური სისტემა ნივთების, ცხოველებისა და Emergency პროფილების დასაცავად — ტექნოლოგია, რომელიც საჭირო მომენტში სწორ ადამიანს სწორ ინფორმაციასთან აკავშირებს."
      ...
      <section className="megaMenu">
        <div className="megaInner shopGrid">
          ...
          <article id="how-to-order">
            ...
            <div className="steps">
              ...
              <Step
                ...
                text={
                  ka
                    ? "გაიარეთ რეგისტრაცია ან შედით თქვენს არსებულ ანგარიშში."
              ...
              <Step
                ...
                text={
                  ka
                    ? "დაასრულეთ ონლაინ შეკვეთა და გადახდა."
              ...
              <Step
                ...
                text={
                  ka
                    ? "პროდუქტის მიღების შემდეგ დაარეგისტრირეთ QR კოდი და მიაბით შესაბამის პროფილს."
                    : "Register the QR code and connect it to the relevant profile."
                }
              />
            </div>
          </article>
          ...
          <article className="storeCard">
            ...
            <p>
              {ka
                ? "QR ბრელოკები, სტიკერები და სხვა პროდუქტები ნივთებისთვის, ცხოველებისთვის და QR RETURN პროფილებისთვის."
                : "QR tags, stickers and other products for belongings, pets and QR RETURN profiles."}
            </p>
  ...
  return (
    <section className="megaMenu" id="faq">
      <div className="megaInner faqGrid">
        <div>
          ...
          <p className="faqIntro">
            {ka
              ? "მთავარი ინფორმაცია QR RETURN-ის გამოყენების, პროფილების, უსაფრთხოებისა და პროდუქტების შესახებ."
              : "Essential information about QR RETURN, profiles, privacy and products."}
          </p>
        </div>
        ...
        <div className="faqList">
          <FAQ
            ...
            answer={
              ka
                ? "QR RETURN არის QR-ზე დაფუძნებული სისტემა ნივთების, ცხოველებისა და Emergency პროფილებისთვის, რომელიც საჭირო მომენტში მპოვნელსა და შესაბამის პირს სწრაფად აკავშირებს."
          ...
          <FAQ
            ...
            answer={
              ka
                ? "დიახ. ერთი ანგარიშიდან შეგიძლიათ მართოთ რამდენიმე ნივთის, ცხოველის ან სხვა QR პროფილი."
                : "Yes. One account can manage multiple QR profiles."
            }
          />
          ...
          <FAQ
            ...
            answer={
              ka
                ? "დიახ. პროფილის ინფორმაცია შეგიძლიათ განაახლოთ თქვენი ანგარიშიდან QR კოდის შეცვლის გარეშე."
